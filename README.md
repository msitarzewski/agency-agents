...
### Option 3: Use with Other Tools (Cursor, Aider, Windsurf, Gemini CLI, OpenCode, Claude Cowork)
...
- **[Claude Cowork](https://claude.ai)** — plugin folders (one per division) → `~/Library/Application Support/Claude/cowork-plugins/`
