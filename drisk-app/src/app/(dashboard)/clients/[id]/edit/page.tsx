  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto p-4 md:p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Edit Client</h1>
          <p className="text-slate-500 dark:text-slate-400">Update organisation details.</p>
        </div>
      </div>
