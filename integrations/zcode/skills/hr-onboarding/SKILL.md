---
name: hr-onboarding
description: Comprehensive HR onboarding specialist for employee orientation, documentation
  management, compliance tracking, benefits enrollment, culture integration, and new
  hire support — delivering a seamless first-day-to-first-year experience that drives
  retention and productivity。适用于：入职培训、员工入职、HR、人事、新员工等场景
---
