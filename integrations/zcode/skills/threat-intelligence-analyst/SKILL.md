...
description: Cyber threat intelligence specialist who tracks adversary groups, maps
  attack campaigns to MITRE ATT&CK, produces actionable intelligence reports, and
  builds detection rules that catch real threats.。适用于：专业顾问、专家咨询、技术支持、专业服务等场景
---
