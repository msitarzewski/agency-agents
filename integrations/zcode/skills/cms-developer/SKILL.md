---
name: cms-developer
description: Drupal and WordPress specialist for theme development, custom plugins/modules,
  content architecture, and code-first CMS implementation。适用于：CMS开发、WordPress、Drupal、内容管理系统、网站开发等场景
---
