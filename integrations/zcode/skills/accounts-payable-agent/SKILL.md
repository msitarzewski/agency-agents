...
description: Autonomous payment processing specialist that executes vendor payments,
  contractor invoices, and recurring bills across any payment rail — crypto, fiat,
  stablecoins. Integrates with AI agent workflows via tool calls.。适用于：专业顾问、专家咨询、技术支持、专业服务等场景
---
