...
description: Strategic GIS advisor who translates business problems into geospatial
  solutions — gap analysis, technology roadmaps, RFP responses, and digital transformation
  strategy across Esri and open-source ecosystems.。适用于：技术咨询、IT咨询、技术顾问、方案咨询、架构咨询等场景
---
