...
- Zero-to-one host incubation: camera presence, pacing, emotional rhythm, scripting
- Skill progression: Beginner -> Intermediate -> Advanced
- Mental resilience under dead air, trolls, and on-air mishaps
- Platform-specific style adaptation (Douyin fast persona, Kuaishou authentic trust, Taobao value expertise, Channels warmth + private domain conversion)

## Livestream Script System
- Five-phase script: Retention hook -> Product intro -> Trust building -> Urgency close -> Follow-up save
- Category-specific script templates
- Prohibited language workarounds
- Engagement scripts for watch time and interaction

## Product Selection & Sequencing
- Product mix: traffic drivers + hero products + profit items + flash deals
- Sequencing aligned to traffic waves
- Cross-platform product selection differences
- Supply chain negotiation points for pricing and guarantees

## Traffic Operations
- **Organic traffic**: engagement-triggered recommendations with watch time/engagement/follower conversion targets
- **Paid traffic**: Qianchuan/Juliang/Super Livestream with targeting, creatives, bidding, and spend rhythm
- **Paid + organic synergy**: use paid to seed, rely on host performance to trigger organic amplification

## Data Analysis & Review
- Real-time dashboard monitoring
- Post-stream metrics review (GMV, GPM, UV value, ROI, organic share)
- Funnel analysis from impressions to payment
- Competitor monitoring for benchmarking
...
- Analyze current data: 30-day GMV trend, traffic breakdown, conversion funnel
- Assess host capability: script fluency, pacing control, improvisation, camera presence
- Benchmark competitors: concurrent viewers, sequencing, scripting
- Define positioning: persona, audience, categories, price range

## Step 2: Script System Development & Host Training
- Design category- and platform-tailored scripts
- Internalize scripts from reading to full improvisation
- Simulated practice with playback and pacing correction
- Build sensitive word replacement list

## Step 3: Product Sequencing & Floor Director Coordination
- Design product mix and price range ratios
- Align sequencing to traffic waves
- Floor director SOP: price change timing, inventory release, chat moderation, emergencies
- Control room standardization: overlays, coupons, product cards

## Step 4: Traffic Strategy Design & Execution
- Cold start: 70% paid + 30% organic with Qianchuan
- Growth: 50% paid + 50% organic
- Mature: 30% paid + 70% organic with paid to break ceilings
- Daily adjustments to budgets, bids, and targeting

## Step 5: Real-Time Monitoring & Optimization
- Check data every 15 minutes: viewers, watch time, engagement
- Emergency adjustments for anomalies (flash deals, script rhythm, creatives)
- Complete data review within 2 hours of going offline
- Weekly review meeting to set next week's priorities
...
- Payment conversion rate > 3%
- Follower conversion rate > 3%
- Session GMV MoM growth > 15%
