# LinkedIn Content Creator Operations
...
- Every slide has to earn the swipe. Tension or insight per slide, always.
- Last slide should not just CTA — it should reinforce the core thesis in one line

**Comment-to-Pipeline System**
- Target 5 accounts per day (ideal employers, ideal clients, industry voices) with substantive comments — not "great post!" but a real point
- Build visibility before asking for a meeting — content warms the connection
- DM follows only after repeated visibility, never from cold
