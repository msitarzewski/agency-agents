...
| Trait | Description |
|-------|-------------|
| **Empowering** | We reframe menopause as a powerful transition, not an ending |
| **Expert-led** | World-class, credentialed speakers — no fluff |
| **Warm & Inclusive** | Every woman deserves to thrive, regardless of background |
| **Boutique & Premium** | Intimate, curated, elevated — not a mass-market conference |
| **Evidence-based** | Science-backed, clinically grounded messaging |
| **Optimistic** | Thriving, not just surviving |

**Brand Voice**: Warm, intelligent, authoritative yet approachable. Speaks to women as equals. Never condescending, never alarmist. Celebrates this life stage as an opportunity for transformation.
...
| Name | Hex | Usage |
|------|-----|-------|
| **Deep Plum** | `#5C2D6E` | Primary headings, CTAs, strong emphasis |
| **Warm Rose** | `#C9778A` | Secondary elements, accents, highlights |
| **Blush Cream** | `#F5EDE8` | Backgrounds, cards, breathing space |
| **Champagne Gold** | `#C9A96E` | Premium accents, borders, icon details |
| **Soft Mauve** | `#A67D9B` | Mid-tone, gradients, supporting elements |
| **Charcoal** | `#2D2B2E` | Body text, dark backgrounds |
| **Off-White** | `#FAF7F4` | Page backgrounds, light sections |

### Gradient Directions
- **Primary Gradient**: `linear-gradient(135deg, #5C2D6E 0%, #A67D9B 50%, #C9778A 100%)`
- **Warm Gradient**: `linear-gradient(135deg, #F5EDE8 0%, #E8D5D0 100%)`
- **Gold Accent**: `linear-gradient(135deg, #C9A96E 0%, #E8D5B5 100%)`
...
| Role | Font | Style |
|------|------|-------|
| **Display/Hero** | Playfair Display | Bold, italic for impact |
| **Headings** | Playfair Display | Regular, Semi-bold |
| **Body** | Lato / Inter | Regular 400, 300 for elegance |
| **Accent/Captions** | Cormorant Garamond | Italic, for quotes and elegant callouts |
| **CTA Buttons** | Lato | Bold, uppercase, tracked |
...
## Imagery Style
- **Photography**: Real women 40s–60s, confident, active, joyful — not stock-photo-sad
- **Setting**: Natural light, warm tones, premium interiors, nature elements
- **Avoidance**: Clinical/cold imagery, stereotypical "old age" tropes, anything that feels pitying
- **Mood**: Radiant, empowered, connected, intelligent
...
- Show diverse women thriving
- Lead with education and expertise
- Create gentle urgency ("limited seats") without pressure tactics
- Celebrate this life stage as transformative

### ❌ Don't
- Use clinical, cold, or scary language about menopause
- Use stock photos of sad or suffering women
- Exaggerate urgency ("BUY NOW!")
- Use overly bright/loud colors that feel mass-market
...
## Campaign Goal
**Sell 200 tickets** to the Thriving Through Menopause Symposium.
Strategy: Build desire through expertise and community, create gentle FOMO through limited seating and speaker calibre, convert through warmth and relevance.
