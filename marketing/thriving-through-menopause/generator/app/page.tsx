...
const CONTENT_TYPES = [
  ...
  { value: "speaker_spotlight", label: "Speaker Spotlight" },
  { value: "urgency_fomo", label: "Urgency / FOMO" },
  { value: "testimonial", label: "Delegate Testimonial / Social Proof" },
  { value: "educational", label: "Educational / Thought Leadership" },
  { value: "vip_focus", label: "VIP Experience" },
];
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          <div className={styles.logo}>
            <div className={styles.logoMark}>TTM</div>
            <div>
              <div className={styles.logoTitle}>Marketing Generator</div>
              <div className={styles.logoSub}>Thriving Through Menopause Symposium 2026</div>
            </div>
          </div>
          <div className={styles.headerMeta}>
            <span className={styles.pill}>19 Oct 2026</span>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.field}>
            ...
            <textarea
              ...
              rows={4}
              placeholder="E.g. Focus on the VIP delegate bag. Mention early bird closes Friday. Target Cosmetic Nurses specifically."
              value={customContext}
